...
public:
    ...
    void OnBattlegroundAddPlayer(Battleground* bg, Player* player) override
    {
        ...
        sCFBG->SetZoePlayerBracket(player, true);
        sCFBG->SetZoeBattlegroundBracket(bg, player);
    ...
    void OnBattlegroundEndReward(Battleground* bg, Player* player, TeamId /*winnerTeamId*/) override
    {
        ...
        sCFBG->ClearZoePlayerBracket(player);
        sCFBG->ClearZoeBattlegroundBracket(bg);
    }
...
public:
    ...
    void OnPlayerBeforeUpdate(Player* player, uint32 diff) override
    {
        ...
        {
            sCFBG->AuditZoeGearBracketEquipment(player, true);
            zoeGearCheck = 5000;
        }
        else
            zoeGearCheck -= diff;
    ...
    {
        return sCFBG->CanEquipZoeGearBracketItem(player, pItem);
    }
