...
public:
    ...
    bool OnGossipHello(Player *player, Creature* creature) override {
        ...
        if (!sConfigMgr->GetOption<bool>("NpcArenaSpectator.Enable", true)) {
            ChatHandler(player->GetSession()).SendSysMessage("Espectador Arena desativado!");
            return true;
        }

        if (player->InBattleground() || player->InArena())
        {
            ChatHandler(player->GetSession()).SendSysMessage("Voce nao pode usar o Espectador Arena dentro de BG/Arena.");
            return true;
        }

        if (sConfigMgr->GetOption<bool>("NpcArenaSpectator.1v1.Enable", false)) {
            AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "|TInterface\\icons\\Achievement_Arena_2v2_1:30:30:-20:0|t 1v1 (|cffff0000" + sArenaSpectatorNPC->GetMatchCount(ARENA_TYPE_1v1) + "|r em andamento)", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_1v1_GAMES);
        }

        AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "|TInterface\\icons\\Achievement_Arena_2v2_4:30:30:-20:0|t 2v2 (|cffff0000" + sArenaSpectatorNPC->GetMatchCount(ARENA_TYPE_2v2) + "|r em andamento)", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_2V2_GAMES);
        AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "|TInterface\\icons\\Achievement_Arena_3v3_4:30:30:-20:0|t 3v3 (|cffff0000" + sArenaSpectatorNPC->GetMatchCount(ARENA_TYPE_3v3) + "|r em andamento)", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_3V3_GAMES);

        if (sConfigMgr->GetOption<bool>("NpcArenaSpectator.3v3soloQ.Enable", false)) {
            AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "|TInterface\\icons\\Achievement_Arena_3v3_4:30:30:-20:0|t Solo 3v3 (|cffff0000" + sArenaSpectatorNPC->GetMatchCount(ARENA_TYPE_3V3_SOLO) + "|r em andamento)", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_3V3SOLO_GAMES);
        }

        if (sConfigMgr->GetOption<bool>("NpcArenaSpectator.Enable5v5", true)) {
            AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "|TInterface\\icons\\Achievement_Arena_5v5_4:30:30:-20:0|t 5v5 (|cffff0000" + sArenaSpectatorNPC->GetMatchCount(ARENA_TYPE_5v5) + "|r em andamento)", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_5V5_GAMES);
        }

        AddGossipItemFor(player, GOSSIP_ICON_DOT, "|TInterface\\icons\\achievement_boss_cthun:30:30:-20:0|tAssistir jogador especifico", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_SPECIFIC, "", 0, true);
        AddGossipItemFor(player, GOSSIP_ICON_DOT, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-20:0|tAtualizar", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_MAIN_MENU);
        AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/inv_misc_questionmark:30:30:-20:0|t Ajuda", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_HELP);
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override {
        ...
        if (action >= NPC_SPECTATOR_ACTION_1v1_GAMES && action < NPC_SPECTATOR_ACTION_2V2_GAMES) {
            ...
            AddGossipItemFor(player, 4, "Atualizar", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_1v1_GAMES);
            ...
            AddGossipItemFor(player, 11, "< Menu Principal >", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_MAIN_MENU);
            AddGossipItemFor(player, 4, "Atualizar", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_2V2_GAMES);
            ...
            AddGossipItemFor(player, 11, "< Menu Principal >", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_MAIN_MENU);
            AddGossipItemFor(player, 4, "Atualizar", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_3V3_GAMES);
        ...
        // 5v5
            ...
            AddGossipItemFor(player, 11, "< Menu Principal >", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_MAIN_MENU);
            AddGossipItemFor(player, 4, "Atualizar", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_5V5_GAMES);
        ...
        // Solo 3v3
            ...
            AddGossipItemFor(player, 11, "< Menu Principal >", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_MAIN_MENU);
            AddGossipItemFor(player, 4, "Atualizar", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_3V3SOLO_GAMES);
    ...
    bool OnGossipSelectCode(Player* player, Creature* creature, uint32 sender, uint32 action, const char* code) override {
        ...
        if (action == NPC_SPECTATOR_ACTION_SPECIFIC) {
            ...
            ChatHandler(player->GetSession()).PSendSysMessage("Jogador nao esta online ou nao existe.");
            OnGossipHello(player, creature);
            return false;
        }
        CloseGossipMenuFor(player);
